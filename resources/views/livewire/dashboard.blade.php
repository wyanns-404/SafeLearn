                        ...
                        <div class="w-full max-w-full px-3 mb-6 md:w-6/12 md:flex-none xl:mb-0 xl:w-3/12">
                            <div
                                ...
                                <div class="flex-auto px-1 pt-6">
                                    <p
                                        class="relative z-10 mb-2 leading-normal text-transparent bg-gradient-dark-gray text-size-sm bg-clip-text">
                                        Project #2</p>
                                    <a href="javascript:;">
                                        <h5>Modern</h5>
                                    </a>
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <a href="javascript:;"
                                                class="relative z-20 inline-flex items-center justify-center w-6 h-6 -ml-4 text-white transition-all duration-200 border-2 border-white border-solid ease-soft-in-out text-size-xs rounded-circle hover:z-30"
                                                data-target="tooltip_trigger" data-placement="bottom">
                                                <img class="w-full rounded-circle" alt="Image placeholder"
                        ...
                        <div class="w-full max-w-full px-3 mb-6 md:w-6/12 md:flex-none xl:mb-0 xl:w-3/12">
                            <div
                                ...
                                <div class="flex-auto px-1 pt-6">
                                    ...
                                    <p class="mb-6 leading-normal text-size-sm">Music is something that every person
                                        has his or her own
                        ...
                        <div class="w-full max-w-full px-3 mb-6 md:w-6/12 md:flex-none xl:mb-0 xl:w-3/12">
                            <div
                                ...
                                <div class="flex-auto px-1 pt-6">
                                    ...
                                    <p class="mb-6 leading-normal text-size-sm">Different people have different taste,
                                        and various types
                                        of music.</p>
                                    <div class="flex items-center justify-between">
                                        <button type="button"
                        ...
                        <div class="flex-none w-2/3 max-w-full px-3">
                            <div>
                                ...
                                <h5 class="mb-0 font-bold">
                                    +3,462
                                    <span
                                        class="leading-normal text-red-600 text-size-sm font-weight-bolder">-2%</span>
                                </h5>
                            </div>
                        </div>
                        <div class="px-3 text-right basis-1/3">
